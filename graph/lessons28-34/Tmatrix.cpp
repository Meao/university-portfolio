...
TMatrix33 & TMatrix33::add(const TMatrix33 & m1,
  const TMatrix33 & m2, TMatrix33 & result) {
...
TMatrix33 & TMatrix33::subtract(const TMatrix33 & m1,
  const TMatrix33 & m2, TMatrix33 & result) {
...
TMatrix33 & TMatrix33::multiply(const TMatrix33 & m1,
  const TMatrix33 & m2, TMatrix33 & result) {
...
TMatrix33 & TMatrix33::multiply(const TMatrix33 & m1,
  const double & scale, TMatrix33 & result) {
...
TVector & TMatrix33::multiply(const TMatrix33 & m1,
  const TVector & v, TVector & result) {
