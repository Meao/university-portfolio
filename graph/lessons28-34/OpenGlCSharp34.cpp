...
#define MAP_SIZE 1024# define STEP_SIZE 16
#define HEIGHT_RATIO 1.5 f
...
GLvoid ReSizeGLScene(GLsizei width, GLsizei height) {
  ...
  gluPerspective(45.0 f, (GLfloat) width / (GLfloat) height, 0.1 f, 500.0 f);
...
void SetVertexColor(BYTE * pHeightMap, int x, int y) {
  ...
  float fColor = -0.15 f + (Height(pHeightMap, x, y) / 256.0 f);
