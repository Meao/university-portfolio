...
TVector::TVector(const TRay & ray1,
  const TRay & ray2) {
...
TVector & TVector::add(const TVector & v1,
  const TVector & v2, TVector & result) {
...
TVector & TVector::subtract(const TVector & v1,
  const TVector & v2, TVector & result) {
...
TVector & TVector::cross(const TVector & v1,
  const TVector & v2, TVector & result) {
...
TVector & TVector::multiply(const TVector & v1,
  const double & scale, TVector & result) {
