...
GLvoid BuildFont(GLvoid) {
  ...
  for (int loop1 = 0; loop1 < 256; loop1++) {
    ...
    glVertex2i(16, 16);
    glTexCoord2f(cx + 0.0625 f, 1.0 f - cy - 0.001 f);
    glVertex2i(16, 0);
    glTexCoord2f(cx, 1.0 f - cy - 0.001 f);
    glVertex2i(0, 0);
    glEnd();
    glTranslated(14, 0, 0);
    glEndList();
...
GLvoid ReSizeGLScene(GLsizei width, GLsizei height) {
  ...
  glLoadIdentity();
  glOrtho(0.0 f, 640, 480, 0.0 f, -1.0 f, 1.0 f);
...
int DrawGLScene(GLvoid) {
  ...
  glScissor(1, int(0.135416 f * sheight), swidth - 2, int(0.597916 f * sheight));
  ...
  while (token != NULL) {
    ...
    glColor3f(0.5 f, 1.0 f, 0.5 f);
    glPrint(0, 96 + (cnt * 32) - scroll, 0, "%i", cnt);
    glColor3f(1.0 f, 1.0 f, 0.5 f);
