...
[Работа кода чтобы выяснить количества вызовов функций на сайте kodaktor, kills browser access](https://kodaktor.ru/func_157fe)
[код чтобы выяснить количества вызовов функций на сайте kodaktor, kills browser access](https://kodaktor.ru/j/func_157fe)
...
[Код Vue to do](/web/Vuetodo.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/fd31784_529fc)
- https://kodaktor.ru/frmw_004
[Код Vue power](/web/Vuepower.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/6f52d3c_a873b)
...
####   XML и валидация XMLT-001, XMLT-002     
Разработка языка разметки  
https://kodaktor.ru/g/xml_intro
...
[Код Массив промисов](/web/async_tasks.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/async_tasks_c1ad7)
...
####  Часть Б. Разработка веб-сценария в функциональном стиле JavaScript с использованием условного (тернарного) оператора TERN-001
...
[Код](/web/ternary.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/ternary_e918f)
Часть Б.
...
[Код falsy](/web/falsy.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/ternary_7e75a)
[Код translate](/web/translate.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/nodelist_e8f1e)
...
6. Разместите адрес борда (а также его скриншот и лог действий) в репозитории (веб-портфолио) и в специально созданном форуме в соответствующем курсе в СДО Moodle.
[Код](/web/jsontable.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/logins09012018_fb73f)
...
[Код](/web/dom_imgins.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/dom_7d424)
...
[Код туду на реакте с удалением x](/web/x.html)
...
2. Экспериментальная проверка корректности документов (валидация) на языках разметки XMLT-001, XMLT-002     
Разработка языка разметки  
https://kodaktor.ru/g/xml_intro
[Работа кода на сайте kodaktor](https://kodaktor.ru/unsafe_1184f)
[Работа кода на сайте kodaktor](https://kodaktor.ru/unsafe_e1a27)
...
![ECMAScript](/web/historyterminal.png)
6. Выполните команду
npx babel ./src -d ./lib
или
yarn run build
для получения оттранспилированных файлов 
![ECMAScript](/web/yarnrunbuild.png)
7. Убедитесь, что всё выполняется без ошибок: node ./lib/index.js
8. Разместите полученный отчёт (лог действий) в репозитории (веб-портфолио).
![ECMAScript](/web/runbynode.png)
...
![веб-сервер](/web/curllocalhost.png)
...
[Код rgb concat](/web/rgb_concat.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/eb41bac_064df)
(goss_concat)
[Код concat](/web/goss_concat.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/task_func_cd81e)
7. Разместите отчёт (лог действий) в репозитории (веб-портфолио).
[Код](/web/mixer.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/9b595bb)
[Код Vue mixer](/web/vuemixer.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/fd31784_3b2f7)
...
[Код histogram](/web/histogram.php)
[Работа кода на сайте kodaktor](https://kodaktor.ru/canvas_f5e1c)
[Код histogram react](/web/histogramreact.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/canvas_85024)
...
4. Формирование отчета по выполнению задания (тема 2) и размещение его в портфолио.
3
1. Разработка приложения для визуализации инфографики 
[Код histogram](/web/histogram.php)
[Работа кода на сайте kodaktor](https://kodaktor.ru/canvas_f5e1c)
2. Разработка приложения для реализации CAPTCHA
3. Разработка приложения с подключением к базе данных с помощью объектно- ориентированного интерфейса.

[Работа кода на сайте kodaktor](https://kodaktor.ru/click_7b063)
...
[Код Audio](/web/Audio.html)
[Работа кода на сайте kodaktor](https://kodaktor.ru/audiobutton_28d9f)
