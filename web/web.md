...
[Работа кода на сайте kodaktor](https://kodaktor.ru/unsafe_dc5b2)
...
описывают пять самых часто встречающихся адресов в порядке убывания 5. Разработайте или сгенерируйте схему (XML Schema) для документа:
